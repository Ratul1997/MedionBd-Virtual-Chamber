...
function History(props) {
  const {item, removeHistory} = props;
  const removeHistorys = () => {
    removeHistory(item);
  };
  return (
    <View
      ...
      <TouchableOpacity onPress={removeHistorys}>
        <AntDesign
          name="closecircle"
...
const actionCreators = {
  removeHistory: history => dispatch =>
    dispatch({type: userConstants.REMOVE_HISTORY, history}),
};
